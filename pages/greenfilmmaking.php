      ...
      <div class="container">
        <h2 class="text-center text-white mt-0 mb-5">Further resources</h2>
         <div class="row justify-content-center">
            ...
            <div class="col-xl-4 col-lg-5 col-md-10 col-sm-10 col-10 mx-5 mb-3">
              <figure class="figure">
                <a target="_blank" rel="noopener noreferrer" href="https://greenshooting.mfg.de"><img src="/user/handlers/fm4fhandler/img/logos/logo_mfg_greenshooting.png" width="250px" class="figure-img img-fluid mb-3" alt="Green Shooting by the MFG Logo"></a>
            ...
            <div class="col-xl-4 col-lg-4 col-md-10 col-sm-10 col-10 mx-5 mb-3">
                <figure class="figure">
                  <a target="_blank" rel="noopener noreferrer" href="https://www.adgreen-apa.net"><img src="/user/handlers/fm4fhandler/img/logos/adgreen-logo.png" width="180px" class="figure-img img-fluid" alt="AdGreen Logo"></a>
                <figcaption class="text-center text-white">AdGreen supports the advertising industry’s transition to environmentally sustainable production methods.
                </figcaption>
                <figcaption class="text-left text-white">
                <ul>
              ...
              <div class="col-xl-4 col-lg-4 col-md-10 col-sm-10 col-10 mx-5 mb-3">
                <figure class="figure">
                  <a target="_blank" rel="noopener noreferrer" href="http://greenfilmtools.com/"><img src="/user/handlers/fm4fhandler/img/logos/GFT_Logo.png" width="180px" class="figure-img img-fluid" alt="Green Film Tools Logo"></a>
              ...
              <div class="col-xl-4 col-lg-4 col-md-10 col-sm-10 col-10 mx-5 mb-3">
                <figure class="figure">
                  <a target="_blank" rel="noopener noreferrer" href="https://creativeindustriespact.com"><img src="/user/handlers/fm4fhandler/img/logos/creative-industries-pact.png" width="170px" class="figure-img img-fluid" alt="Creative Industries Pact Logo"></a>
